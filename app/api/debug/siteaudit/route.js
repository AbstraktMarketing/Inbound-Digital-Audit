...
function Dashboard() {
  ...
  e('div', {
  ...
  }, '$1,000')))))), activeTab === 'ss' && e('div', null, e('div', {
    className: 'grid-2',
    style: {
      marginBottom: '16px'
    }
  ...
  }, "We were at $6,500 MRR closed on 1/9, and have since increased to $22,091 MRR, demonstrating stronger closing velocity and improved month-end execution.")), e('div', {
    className: 'insight-card',
    style: {
      backgroundColor: 'rgba(13,148,136,0.05)',
      border: '1px solid rgba(13,148,136,0.15)'
    ...
    className: 'insight-title'
  }, 'Pipeline Activity Increased Meaningfully'), e('p', {
    className: 'insight-text'
  }, 'We issued 4 proposals this month, reflecting early-month pipeline activity.')), e('div', {
    className: 'insight-card',
    style: {
      backgroundColor: 'rgba(13,148,136,0.05)',
      border: '1px solid rgba(13,148,136,0.15)'
    ...
    className: 'insight-title'
  }, 'Referral Channels Are Driving High-Quality Growth'), e('p', {
    className: 'insight-text'
  }, 'Employee and client referrals generated $11,000 (69%) of total MRR with close rates of 37.5% and 66.7%.'))), e('div', {
    className: 'card'
  }, e('h3', {
    className: 'section-title'
  }, e('span', {
    ...
    className: 'insight-card',
    style: {
      backgroundColor: 'rgba(244,111,10,0.05)',
      border: '1px solid rgba(244,111,10,0.15)'
    }
  }, e('h4', {
    className: 'insight-title'
  }, 'Digital Audit Conversion Is Underperforming'), e('p', {
    className: 'insight-text'
  }, 'Digital Audit leads produced 52 pitches and only 1 closed deal (1.9% close rate). We are tightening qualification criteria this week to filter low-intent leads before they reach sales.')), e('div', {
    className: 'insight-card',
    style: {
      backgroundColor: 'rgba(244,111,10,0.05)',
      border: '1px solid rgba(244,111,10,0.15)'
    ...
    className: 'insight-text'
  }, 'Project revenue at 55% of January level. We are reallocating sales effort toward referral pipeline and existing client upsells starting next week.')))), e('div', {
    className: 'exec-outcomes',
    style: {
      marginTop: 16
    }
  }, e('h4', null, 'Expected Outcomes'), e('ul', null, e('li', null, e('span', {
    style: {
      color: teal,
      marginRight: '6px'
    }
  }, '✓'), 'Higher revenue predictability'), e('li', null, e('span', {
    style: {
      color: teal,
      marginRight: '6px'
    }
  }, '✓'), 'Improved sales capacity utilization'), e('li', null, e('span', {
    style: {
      color: teal,
      marginRight: '6px'
    }
  }, '✓'), 'Reduced low-quality inbound volume'), e('li', null, e('span', {
    style: {
      color: teal,
      marginRight: '6px'
    }
  }, '✓'), 'Clear accountability for revenue execution'))), e('div', {
    className: 'card',
    style: {
      marginTop: 16
    }
  ...
  }), 'Execution Plan to Hit Revenue Targets'), e('p', {
    className: 'exec-subtitle'
  }, 'Objective: Close the remaining $' + gapToGoal.toLocaleString() + ' gap to hit $' + mrrGoal.toLocaleString() + ' MRR goal.'), e('div', {
    className: 'deals-needed-row'
  }, e('span', {
    className: 'deals-needed-label'
  }, 'To close the gap:'), e('span', {
    className: 'deals-needed-item'
  }, e('strong', null, referralDealsNeeded), ' referral deals @ $' + avgReferralDealSize.toLocaleString() + ' avg'), e('span', {
    className: 'deals-needed-sep'
  }, 'or'), e('span', {
    className: 'deals-needed-item'
  }, e('strong', null, transferDealsNeeded), ' transfer deals @ $' + avgTransferDealSize.toLocaleString() + ' avg'), e('span', {
    className: 'deals-needed-sep'
  }, 'or'), e('span', {
    className: 'deals-needed-item'
  }, e('strong', null, auditDealsNeeded), ' audit deals @ $' + avgAuditDealSize.toLocaleString() + ' avg')), e('div', {
    className: 'exec-grid'
  }, e('div', {
    className: 'exec-item'
  }, e('div', {
    className: 'exec-num',
    style: {
      backgroundColor: 'rgba(140,8,43,0.15)',
      color: maroon
    }
  }, '1'), e('div', {
    className: 'exec-content'
  }, e('h4', null, 'Scale Referral Revenue'), e('ul', null, e('li', null, 'PSMs will request 2 referrals per client touchpoint starting this week.'), e('li', null, 'Doug to run referral blitz with top 10 accounts by Friday.')), e('div', {
    className: 'exec-kpi'
  }, e('span', null, 'KPI: '), '≥ 50% of inbound MRR from referrals'))), e('div', {
    className: 'exec-item'
  }, e('div', {
    className: 'exec-num',
    style: {
      backgroundColor: 'rgba(244,111,10,0.15)',
      color: orange
    }
  }, '2'), e('div', {
    className: 'exec-content'
  }, e('h4', null, 'Correct Audit Lead Qualification'), e('ul', null, e('li', null, 'Adding budget and timeline questions to audit intake form today.'), e('li', null, 'Rejecting leads under $1,500 MRR potential before pitch.')), e('div', {
    className: 'exec-kpi'
  }, e('span', null, 'KPI: '), 'Audit close rate ≥ 5%'))), e('div', {
    className: 'exec-item'
  }, e('div', {
    className: 'exec-num',
    style: {
    ...
    className: 'exec-content'
  }, e('h4', null, 'Restore Project Revenue Contribution'), e('ul', null, e('li', null, 'PSMs to identify 1 upsell opportunity per account review.')), e('div', {
    className: 'exec-kpi'
  }, e('span', null, 'KPI: '), 'Monthly project revenue ≥ $18K'))), e('div', {
    className: 'exec-item'
  }, e('div', {
    className: 'exec-num',
    style: {
    ...
    className: 'exec-content'
  }, e('h4', null, 'Maximize Month-End Close Velocity'), e('ul', null, e('li', null, 'Daily pipeline standup at 9am through Feb 14.'), e('li', null, 'All proposals over $2K get VP follow-up within 24 hours.')), e('div', {
    className: 'exec-kpi'
  }, e('span', null, 'KPI: '), 'Month-end MRR ≥ $20K'))), e('div', {
    className: 'exec-item'
  }, e('div', {
    className: 'exec-num',
    style: {
    ...
    className: 'exec-content'
  }, e('h4', null, 'Increase Average Deal Size'), e('ul', null, e('li', null, 'Leverage Paid, Social Management, Backlinking, and Collateral add-ons.'), e('li', null, 'Bundle services on every proposal to maximize contract value.')), e('div', {
    className: 'exec-kpi'
  }, e('span', null, 'KPI: '), 'Avg deal size ≥ $3K')))))), activeTab === 'rr' && e('div', null,
