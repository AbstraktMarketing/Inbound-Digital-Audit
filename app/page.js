...
body { font-family: Barlow, sans-serif; }
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .dark .card { background: #1e293b; border-color: #334155; box-shadow: 0 2px 8px rgba(0,0,0,0.3); }
    .dark .kpi-highlight { background: linear-gradient(135deg, #134e4a 0%, #0f172a 100%); border-color: #0d9488; }
    .dark .kpi-label { color: #94a3b8; }
    .dark .kpi-hero { color: #f1f5f9; }
    .dark .kpi-meta { color: #94a3b8; }
    .dark .kpi-recap-dark { background: rgba(0,0,0,0.3); }
    .dark .kpi-recap-header { color: #64748b; }
    .dark .kpi-label-sm { color: #94a3b8; }
    .dark .kpi-meta-sm { color: #64748b; }
    .dark .header h1 { color: #f1f5f9; }
    .dark .date-badge { background: #1e293b; border-color: #334155; }
    .dark .date-badge span { color: #f1f5f9; }
    .dark .tab { color: #94a3b8; }
    .dark .tab:hover { color: #f1f5f9; }
    .dark .tab.active { background: #8C082B; color: #fff; }
    .dark .section-title { color: #f1f5f9; }
    .dark th { color: #94a3b8; border-bottom-color: #334155; }
    .dark td { border-bottom-color: #1e293b; color: #cbd5e1; }
    .dark tr:hover { background: rgba(255,255,255,0.04); }
    .dark .insight-title { color: #f1f5f9; }
    .dark .insight-text { color: #94a3b8; }
    .dark .deal-name { color: #f1f5f9; }
    .dark .deal-source { color: #94a3b8; }
    .dark .total-row { border-top-color: #334155; }
    .dark .total-label { color: #94a3b8; }
    .dark .exec-takeaway { background: linear-gradient(135deg, rgba(13,148,136,0.15) 0%, rgba(140,8,43,0.15) 100%); border-color: rgba(13,148,136,0.3); }
    .dark .exec-takeaway-list li { color: #cbd5e1; }
    .dark .retention-row { background: rgba(255,255,255,0.04); }
    .dark .retention-name { color: #f1f5f9; }
    .dark .pace-tracker-card { background: #1e293b; border-color: #334155; }
    .dark .pace-tracker-row { background: rgba(255,255,255,0.04); }
    .dark .pace-tracker-month { color: #f1f5f9; }
    .dark .churn-card { background: #1e293b; border-color: #334155; }
    .dark .churn-month { color: #f1f5f9; }
    .dark .v-bar-track { background: #334155; }
    .dark .v-bar-label { color: #94a3b8; }
    .dark .exec-item { background: rgba(255,255,255,0.04); }
    .dark .exec-content h4 { color: #f1f5f9; }
    .dark .toggle-btn { background: #334155; border-color: #475569; color: #94a3b8; }
    .dark .toggle-btn:hover { background: #475569; color: #f1f5f9; }
</style>
</head>
<body>
<div id="root"></div>
...
function Dashboard() {
  ...
  }, "March 2026"), /*#__PURE__*/React.createElement("button", {
  ...
  }, darkMode ? '☀ Light' : '🌙 Dark')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 0,
      marginBottom: '20px',
  ...
  e('tbody', null,
    ...[
      { source: 'Web Lead',          deals: 5, revenue: 24112, pitches: 12 },
  ...
  e('tfoot', null, e('tr', { style: { borderTop: '2px solid #e2e8f0' } },
    e('td', { style: { padding: '9px 12px', fontWeight: 700, color: '#1e293b' } }, 'Total'),
    e('td', { style: { padding: '9px 12px', textAlign: 'center', fontWeight: 700, color: '#64748b' } }, '147'),
    ...
    e('td', { style: { padding: '9px 12px', textAlign: 'right', fontWeight: 700, color: '#1e293b' } }, '14.3%'),
  ...
  }, '$18,500')))))), activeTab === 'ss' && e('div', null,
